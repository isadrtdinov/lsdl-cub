...
stl_classnames = ['airplane', 'bird', 'car', 'cat', 'deer', 'dog', 'horse', 'monkey', 'ship', 'truck']
stl_class_to_cifar = [0, 2, 1, 3, 4, 5, 7, 6, 8, 9]
...
class STL10Wrapper(VisionDataset):
    def __init__(self, stl10_dataset):
        self.stl10_dataset = stl10_dataset

    def __getitem__(self, index):
        image, label = self.stl10_dataset[index]
        return image, stl_class_to_cifar[label]
...
class STL10:
    def __init__(self,
        ...
        self.test_dataset = STL10Wrapper(self.test_dataset)
